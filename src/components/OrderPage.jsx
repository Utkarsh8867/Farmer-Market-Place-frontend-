...
//     if (method !== "COD") {
//       alert(`${method} is not available right now.`);
//     } else {
...
//     const orderDetails = {
//       userId,
//       cart: cart.items, // Assuming cart.items is the array of cart products
...
//     try {
//       const response = await fetch(`http://localhost:8000/api/v2/order/create-order`, {
//         method: "POST",
//         headers: {
//           "Content-Type": "application/json",
//         },
...
//                 <div key={product.productId._id} className="flex justify-between items-center">
//                   <div>
//                     <img
...
//                       className="mr-2"
//                       checked={selectedAddress === address} // Make sure the selected address is checked
//                     />
//                     <span>
...
//             <div className="space-y-2">
//               {["Debit Card", "Credit Card", "UPI", "COD"].map((method) => (
...
//                   />
//                   <span className="text-center text-sm font-medium">{product.productId?.name}</span>
